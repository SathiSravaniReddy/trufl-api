...
namespace Trufl.Services.Controllers
{
    ...
    public class HostessWaitListUserController : ApiController
    {
        ...
        [Route("BookingCancel")]
        [HttpPost]
        public object BookingCancel(int BookingID, int BookingStatus)
        {
            //bool res = new DataTable();
            try
            {
        ...
        [Route("UpdateGetSeatedNow/{RestaurantID}/{TableType}/{UpdateTableCount}")]
        [HttpPost]
        public object UpdateGetSeatedNow(int RestaurantID, int TableType, int UpdateTableCount)
        {
            try
            {
                bool res = _hostessBL.UpdateGetSeatedNow(RestaurantID, TableType, UpdateTableCount);
                return Json(new JsonResponseResult { _ErrorCode = TruflConstants._ErrorCodeSuccess, _Data = res, _StatusCode = TruflConstants._StatusCodeOK, _StatusMessage = TruflConstants._StatusMessageSuccess });
            }
            catch (Exception ex)
            {
