...
namespace EmailService
{
    public class MailUtility
    {
        ...
        private static void sendMailUsingSMTP(ResetPasswordEmailDTO user, TruflEmailDetails emailSetting)
        {
        ...
        private static object GetMailSettingForResetPassword(ResetPasswordEmailDTO email)
        {
        ...
        public static void sendMail(ResetPasswordEmailDTO email)
        {
